        ...
        <div class="row">
            <div class="col-12">
                <div id="food-categories">
                    <div class="food-categorie m-2 px-3 py-2 rounded">
                    ...
                    <div id="foods">
                        <div class="card m-2">
                            ...
                            <div class="card-body">
                              ...
                              <a href="#" class="btn btn-primary btn-sm">Pedir</a>
                            </div>
                        </div>
                        <div class="card m-2">
            ...
            <div class="col-12">
                <div class="pt-5">
                    ...
                    <div id="stores">
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/naypes.jpg')}}">
                        ...
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/caprichado.jpg')}}">
                            <h6 class="mt-2 small">Caprichado</h6>
                        </div>
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/vovo-dag.jpg')}}">
                            <h6 class="mt-2 small">Vovó Dag</h6>
                        </div>
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/acaiformosa.jpg')}}">
                            <h6 class="mt-2 small">Açaí Formosa</h6>
                        </div>
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/dominos.jpg')}}">
                            <h6 class="mt-2 small">Domino's Pizza</h6>
                        </div>
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/haruy-sushi.jpg')}}">
                            <h6 class="mt-2 small">Haruy Sushi</h6>
                        </div>
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/xpicanha.jpg')}}">
                            <h6 class="mt-2 small">X Picanha</h6>
                        </div>
                        <div class="store m-2 px-3 py-2 rounded">
                            <img class="border rounded" src="{{storage('assets/home/oggi.jpg')}}">
